...
check('xai default is grok-4.5 (BAT-1124: new flagship default)', mc.defaultModelForProvider('xai', 'oauth'), 'grok-4.5');
check('xai model list includes grok-4.5 (new default)', mc.modelsForProvider('xai', 'api_key').some((m) => m.id === 'grok-4.5'), true);
check('xai model list still includes grok-4.3 (retained)', mc.modelsForProvider('xai', 'api_key').some((m) => m.id === 'grok-4.3'), true);
...
check('claude/claude-fable-5 → yes',
