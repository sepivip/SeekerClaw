...
// BAT-1055/1057: getTokenAccountsByOwner mock — the conversion balance pre-check
// (and BAT-1055 solana_balance) read it. Default empty. Conversion tests set a
// held-token balance. Signature (owner, filter).
