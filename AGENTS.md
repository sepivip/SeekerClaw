# AGENTS.md — SeekerClaw Project Guide
...
|---------|---------|----------|
| **App** | `2.0.0` (code 20) | `app/build.gradle.kts` → `versionName` / `versionCode` |
...
- `Codex-opus-4-7` — smartest, newest (Opus 4.7) — **default for fresh installs**
- `Codex-opus-4-6` — previous flagship (Opus 4.6)
- `Codex-sonnet-4-6` — balanced, recommended (Sonnet 4.6)
- `Codex-haiku-4-5` — fast, cheapest (Haiku 4.5)
...
> **Full spec:** See `SKILL-FORMAT.md` — Codex uses this as the reference when creating skills.
