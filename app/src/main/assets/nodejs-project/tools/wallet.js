...
const tools = [
    ...
    },
    {
        ...
        description:
            ...
            'with values as atomic-unit strings, or { error, reason } on invalid input / no cap fields / bridge ' +
            'failure. Each call REQUIRES user confirmation; the confirmation card shows an old → new diff ' +
