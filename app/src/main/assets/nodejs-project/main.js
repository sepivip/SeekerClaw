...
const {
    ...
    SOUL_PATH, MEMORY_PATH, HEARTBEAT_PATH, MEMORY_DIR, SKILLS_DIR,
    ...
    localTimestamp, localDateStr, log, normalizeSecret, setRedactFn,
...
// File paths (SOUL_PATH, MEMORY_PATH, etc.), truncation (truncateToolResult),
// and directory creation are handled in config.js.
...
const {
    BOOTSTRAP_PATH, IDENTITY_PATH, USER_PATH, DEFAULT_SOUL,
    loadSoul, loadBootstrap, loadIdentity, loadUser,
    loadMemory, saveMemory, getDailyMemoryPath, loadDailyMemory, appendDailyMemory,
...
const {
    ...
    sentMessageCache, recordSentMessage,
    sendMessage, sendTyping, sendStatusMessage, deleteStatusMessage, deferStatus,
} = require('./telegram');
...
// Vision analysis, Claude usage state, agent health tracking
// are now in claude.js (BAT-203)

// Solana RPC, base58, transaction building, Jupiter DEX, wallet management
// are now in solana.js (BAT-201)
...
// formatDuration() is now imported from cron.js (BAT-200)

// Claude API, conversations, sessions, system prompt, usage/health tracking
// are now in claude.js (BAT-203)
