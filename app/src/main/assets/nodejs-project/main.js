...
function buildSystemBlocks(matchedSkills = [], chatId = null) {
    ...
    lines.push('**JavaScript execution:** Use js_eval to run JavaScript code inside the Node.js process. Supports async/await, require(), and all Node.js built-ins (fs, path, http, crypto, etc.). Use for computation, data processing, JSON manipulation, HTTP requests, or anything that needs JavaScript. 30s timeout. Prefer js_eval over shell_exec when the task involves data processing or logic.');
