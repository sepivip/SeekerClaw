...
function buildSystemBlocks(matchedSkills = [], chatId = null) {
    ...
    if (CHANNEL === 'telegram') {
        ...
        lines.push(`**File sending (outbound):** Use the send_file tool to upload any workspace file to the user's Discord DM. Auto-detects type from extension. Max 25MB (Discord limit). Use for sharing reports, camera captures, exported CSVs, or any file the user needs.`);
    }
