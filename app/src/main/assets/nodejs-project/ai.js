...
function buildSystemBlocks(matchedSkills = [], chatId = null, activeModel = MODEL) {
    ...
    lines.push('- `deposit_craft_failed` / `create_failed` — Jupiter rejected the deposit-craft or the create POST. Surface the HTTP status from `reason`. Do NOT auto-retry — the deposit may have signed already; check the Jupiter UI.');
