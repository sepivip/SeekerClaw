...
**Fix:**
- "does not support" hint: switch to a yes-supporting model (Fable 5, Opus 4.8/4.7/4.6, Sonnet 4.6, GPT-5.6 Sol/Terra/Luna, GPT-5.5/5.4/5.4 Mini) via `/model` or Settings.
